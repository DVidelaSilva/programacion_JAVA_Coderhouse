...
import com.coderhouse.clase12_springboot3.dtos.AsignacionCategoriaDto;
...
import com.coderhouse.clase12_springboot3.services.CursoService;
...
public class CursoController {
    ...
    public ResponseEntity<Curso> asignarCategoriaACurso(@RequestBody AsignacionCategoriaDto asignacionDto){
        try {
            ...
            Curso cursoActualizado = cursoService.asignarCategoriaACurso(asignacionDto.getCursoId(), asignacionDto.getCategoriaId());
